...
func TestOperationalIntegration(t *testing.T) {
	...
	router := delivery.NewRouter(cfg, driverHandler, tripHandler, incidentHandler, authHandler, vehicleHandler, nil, nil, nil, authMiddleware, rateLimiter.Limit, entitlementUseCase, log)
